<?php 
	class FastpayIpnModuleFrontController extends ModuleFrontController
	{
		/**
		...
		**/
		...
		public function postProcess()
		{
            ...
            $store_passwd = Configuration::get('FASTPAY_STORE_PASSWORD');
        	...
        	elseif($status == 'VALID' || $status == 'VALIDATED')
        	{
        		...
        		{	
        			...
        			if($this->fastpay_hash_key($store_passwd, $_POST))
        			{
